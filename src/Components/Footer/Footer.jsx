...
const Footer = () => {
    return (
        <div>
            <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10">
                ...
                <nav>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <a className='p-1 bg-white rounded-full text-black'>
                            <svg
            ...
            <aside className="footer sm:footer-horizontal footer-center bg-neutral text-neutral-content p-4 flex justify-between">
