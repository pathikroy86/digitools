...
const Pricing = () => {
    return (
        <div className='w-11/12 md:w-10/12 mx-auto mb-5 md:mb-16'>
            <h1 className='text-5xl text-center font-bold mb-2'>Simple, Transparent Pricing</h1>
            <p className='text-[#627382] text-center mb-5'>Choose the plan that fits your needs. Upgrade or downgrade anytime.</p>
